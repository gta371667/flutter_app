...
class DBUtil {
  ...
  /// 新增一筆
  Future<int> insertItem(SQLiteTable table,
  ...
  Future<List<Map<String, dynamic>>> getItem(SQLiteTable table,
  ...
  /// 根據條件刪除
  Future<int> deleteItem(SQLiteTable table,
      {String where, List<dynamic> whereArgs}) async {
    await _dbInitCheck();
  ...
  /// 修改/更新
  Future<int> updateItem(SQLiteTable table,
